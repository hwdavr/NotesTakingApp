...
object EmojiPickerUiMapper {
    ...
    private val nameResourceByKey = mapOf(
        ...
        EmojiNameKey.SLIGHTLY_SMILING_FACE to R.string.emoji_name_slightly_smiling_face,
        EmojiNameKey.BEAMING_FACE_WITH_SMILING_EYES to R.string.emoji_name_beaming_face_with_smiling_eyes,
        EmojiNameKey.CRYING_FACE to R.string.emoji_name_crying_face,
        ...
        EmojiNameKey.THUMBS_DOWN to R.string.emoji_name_thumbs_down,
        EmojiNameKey.RAISING_HANDS to R.string.emoji_name_raising_hands,
        EmojiNameKey.OK_HAND to R.string.emoji_name_ok_hand,
        ...
        EmojiNameKey.MONKEY_FACE to R.string.emoji_name_monkey_face,
        EmojiNameKey.LION to R.string.emoji_name_lion,
        EmojiNameKey.PANDA to R.string.emoji_name_panda,
        ...
        EmojiNameKey.BANANA to R.string.emoji_name_banana,
        EmojiNameKey.DOUGHNUT to R.string.emoji_name_doughnut,
        EmojiNameKey.HOT_BEVERAGE to R.string.emoji_name_hot_beverage,
        ...
        EmojiNameKey.MUSICAL_NOTE to R.string.emoji_name_musical_note,
        EmojiNameKey.VIDEO_GAME to R.string.emoji_name_video_game,
        EmojiNameKey.SPORTS_MEDAL to R.string.emoji_name_sports_medal,
        ...
        EmojiNameKey.TRAIN to R.string.emoji_name_train,
        EmojiNameKey.BICYCLE to R.string.emoji_name_bicycle,
        EmojiNameKey.BEACH_WITH_UMBRELLA to R.string.emoji_name_beach_with_umbrella,
        ...
        EmojiNameKey.BOOKS to R.string.emoji_name_books,
        EmojiNameKey.BELL to R.string.emoji_name_bell,
        EmojiNameKey.HEADPHONE to R.string.emoji_name_headphone,
        ...
        EmojiNameKey.CROSS_MARK to R.string.emoji_name_cross_mark,
        EmojiNameKey.PURPLE_HEART to R.string.emoji_name_purple_heart,
        EmojiNameKey.HIGH_VOLTAGE to R.string.emoji_name_high_voltage,
        ...
        EmojiNameKey.SOUTH_KOREA to R.string.emoji_name_flag_south_korea,
        EmojiNameKey.INDIA to R.string.emoji_name_flag_india,
        EmojiNameKey.FRANCE to R.string.emoji_name_flag_france
    )
