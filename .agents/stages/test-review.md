...
## Purpose
Verify the quality, coverage, and correctness of the tests implemented in the Testing stage.
...
- `gates/ci-checks.md`
- `unit_test/test_report_v<N>.md` (Testing stage output)
...
Verify the results reported in the Testing stage:
```bash
...
Update `summary.md`: mark the Test Review stage complete with test review verdict.
