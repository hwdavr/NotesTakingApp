...
- `request_analysis/spec.md` — UiState design and visual specification from Stage 01
- `request_analysis/design/` — **original design screenshots** provided by the user in Stage 01 (e.g. `design.png`)
...
Locate the original design screenshot from `request_analysis/design/` (uploaded in Stage 01).
