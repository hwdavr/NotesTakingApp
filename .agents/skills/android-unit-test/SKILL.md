...
- **Base Class**: ViewModel unit tests should inherit from [BaseViewModelTest](app/src/test/java/com/example/notesapp/base/BaseViewModelTest.kt).
...
- **Base Class**: ViewModel integration tests should inherit from [BaseViewModelIntegrationTest](app/src/test/java/com/example/notesapp/base/BaseViewModelIntegrationTest.kt).
