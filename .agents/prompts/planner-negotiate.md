...
*   **Provide Executable Commands**: Ensure the exact Gradle commands are listed to execute only the targeted tests (e.g., `./gradlew testDebugUnitTest --tests "com.example.notesapp.data.repository.NoteCommentRepositoryTest"`).
