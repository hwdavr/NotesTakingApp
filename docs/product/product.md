...
| table-handles | Table Column & Row Handles | [docs/product/2026-08-16-table-handles/](2026-08-16-table-handles/) | To be human reviewed | 2026-08-16 | Fix pass applied; re-verification evidence attached; 9/9 findings fixed. Source/test commit `a0c9533`; JVM, 20/20 connected UI, visual, quality, platform, and lifecycle gates pass. |
<!-- HARNESS_TRACKER_END -->
