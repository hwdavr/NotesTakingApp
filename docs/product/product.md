...
|---|---|---|---|---|---|
| basic-blocks-sheet | Basic Blocks Panel | [docs/product/2026-08-16-basic-blocks-sheet/](2026-08-16-basic-blocks-sheet/) | To be reviewed | 2026-08-16 | US-1/US-2/US-3/US-4 passing. US-4 (Amendment v1 / Q12 — auto-collapse on outside interaction) delivered and verified. Workspace ready for evaluation. |
