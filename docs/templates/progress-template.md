...
> Tracks which slice is active and the outcome of each gate.
> Updated by the agent after every gate in the feature-delivery loop.
...
| Task | Name | Status | Implementation | Code Review | Testing | Test Review | Completed |
|------|------|--------|---------------|-------------|---------|-------------|-----------|
| 1 | <Short Name> | ⏳ In Progress | ⬜ | ⬜ | ⬜ | ⬜ | |
| 2 | <Short Name> | ⬜ Not Started | ⬜ | ⬜ | ⬜ | ⬜ | |
| 3 | <Short Name> | ⬜ Not Started | ⬜ | ⬜ | ⬜ | ⬜ | |
