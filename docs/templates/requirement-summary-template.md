...
<One paragraph description of what is being built, end-to-end, in plain language.>

---

## Expected Behavior

1. <Observable, independently testable behavior>
2. <Observable, independently testable behavior>
3. ...
...
1. <Constraint imposed by business logic>
...
1. <Technical or platform constraint already known>
