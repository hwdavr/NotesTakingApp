...
| 3.2 | Must not depend on UI classes | 🤖 Scripted | §3e: `com.example.notesapp.ui.*` imports in domain files | |
...
| 3.5 | Must not import data-layer classes | 🤖 Scripted | §3d: `com.example.notesapp.data.*` imports in domain files | |
...
| **§3d** — Domain files importing `com.example.notesapp.data.*` | 3.5 · 3.6 |
| **§3e** — Domain files importing `com.example.notesapp.ui.*` | 3.2 · 3.6 |
